            ...
            <div class="card mb-3" id="types">
                <div class="card-body">
                    ...
                    <ol>
                        ...
                        <li>ติ๊ก <strong>ไม่นับในรายงาน</strong> ถ้าไม่ต้องการให้ประเภทนี้ถูกนับในยอดรวมปกติ <span class="badge bg-info ms-1" style="font-size:.65rem">v1.10.0</span></li>
                        <li>กดปุ่ม <strong>Save</strong></li>
                    </ol>
                    ...
                    <h6 class="mt-3">ไม่นับในรายงาน <span class="badge bg-info ms-1" style="font-size:.65rem">v1.10.0</span></h6>
                    <p class="small text-muted mb-2">สำหรับรายจ่ายที่อยากบันทึกไว้แต่ไม่ใช่ของสะสมของตัวเอง &mdash; เช่น ค่าเดินทางไปงาน ของฝากที่ซื้อให้คนอื่น หรือของที่ซื้อมาขายต่อ รายการของประเภทที่ติ๊กไว้จะไม่ถูกนับใน KPI หน้าแดชบอร์ด รายงานทุกแท็บ งบประมาณ ตารางรายการ และไฟล์ส่งออก Excel</p>
                    <p class="small text-muted mb-2"><strong>ข้อมูลไม่ได้ถูกลบหรือซ่อนแบบเงียบๆ</strong> ยอดที่ถูกกันออกจะแสดงให้เห็นเสมอ &mdash; ในกล่องสรุปของหน้า Types, เป็นข้อความ &ldquo;ไม่รวม &#3647;X&rdquo; ใต้ยอดรวมบนแดชบอร์ด และเป็นแถบแจ้งเตือนบนหน้า Reports กับ Items ทุกหน้ามีสวิตช์ <strong>รวมประเภทที่ยกเว้น</strong> ให้เปิดดูได้ และค่านี้ใช้ร่วมกันทุกหน้า ในหน้า Items ยังกรองด้วยประเภทนั้นตรงๆ เพื่อดูรายการได้เสมอไม่ว่าสวิตช์จะเปิดหรือปิด</p>
                    <p class="small text-muted mb-2">มีข้อยกเว้น 2 อย่างที่ควรรู้: <a href="#budget">งบประมาณ</a> ที่ตั้งเป้าไปที่ประเภทที่ยกเว้นโดยตรงจะยังนับยอดเต็มจำนวน (เพราะตั้งใจเจาะจงไปที่ประเภทนั้น) และหน้า <a href="#events">Events</a> จะยังนับทุกรายการสำหรับการตรวจจับ ticket &mdash; ไม่งั้นตั๋วที่ซื้อให้เพื่อนจะทำให้ขึ้น &ldquo;ยังไม่มี ticket&rdquo; ผิดๆ</p>
                    <p class="small text-muted mb-2"><strong>ถ้าเปลี่ยนชื่อประเภท</strong> รายการเดิมจะยังใช้ชื่อเก่าและหลุดจากการยกเว้น ทำให้ยอดกลับเข้ามาในทุกรายงานทันที ระบบจะตรวจพบตอนกดบันทึกและถามว่าต้องการเปลี่ยนชื่อในรายการเหล่านั้นด้วยหรือไม่ &mdash; ควรตอบตกลง ยกเว้นตั้งใจจะแยกประเภท</p>
