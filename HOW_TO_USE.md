...
9. [นำเข้า/ส่งออกข้อมูล Excel](#9-นำเขาสงออกขอมูล-excel)
...
> **สำคัญ:** เมื่อเข้าสู่ระบบด้วยรหัสผ่าน `admin` ครั้งแรก ระบบจะบังคับให้เปลี่ยนรหัสผ่านทันทีก่อนเข้าใช้งาน (รหัสผ่านใหม่ต้องมีความยาวขั้นต่ำ 12 ตัวอักษร)

> **การป้องกัน Brute-force:** หากล็อกอินผิด 5 ครั้งขึ้นไปใน 15 นาที ระบบจะบล็อก IP นั้นชั่วคราว 15 นาที
...
| ตัวกรอง | คำอธิบาย |
|---------|----------|
| **Idol** | กรองตามชื่อไอดอล/กลุ่ม — **เลือกได้หลายรายการ** |
| **Type** | กรองตามประเภทสินค้า — **เลือกได้หลายรายการ** |
| **Date Range** | กรองตามช่วงวันที่ |
| **Search** | ค้นหาจากชื่อสินค้า |

> **Idol** และ **Type** รองรับ multi-select: คลิกเพื่อเปิด dropdown → พิมพ์เพื่อค้นหา → เลือกได้หลายรายการพร้อมกัน → ค่าที่เลือกแสดงเป็น badge (คลิก × เพื่อยกเลิกทีละรายการ)

นอกจากนี้ที่แถวตัวกรองยังมีปุ่ม **Export** (สีเขียว) สำหรับดาวน์โหลดข้อมูลที่กรองอยู่เป็น Excel และปุ่ม **Clear** สำหรับล้างตัวกรองทั้งหมด
...
- **คลิกที่เดือนใดก็ได้** เพื่อดูรายละเอียดรายวันในเดือนนั้น พร้อมกับ:
  - **Type Breakdown** — กราฟ doughnut (Top 10 by Type) และตาราง แสดงสัดส่วนยอดใช้จ่ายแยกตามประเภทสินค้าในเดือนนั้น
  - **Idol Breakdown** — กราฟ doughnut (Top 10 by Idol + Others) และตาราง แสดงสัดส่วนยอดใช้จ่ายแยกตามไอดอลในเดือนนั้น (คลิกชื่อไอดอลเพื่อดูรายละเอียดได้)
- **คลิกที่วันในตาราง Daily Breakdown** เพื่อไปยังหน้า Items ที่กรองเฉพาะวันนั้น
...
- **คลิกที่เดือนในตาราง Monthly Breakdown** เพื่อไปยังหน้า Items ที่กรองเฉพาะสมาชิกและเดือนนั้น
...
- **คลิกที่ชื่อประเภท** เพื่อดูรายละเอียด:
  - รายชื่อสมาชิก กลุ่ม และค่ายที่ซื้อสินค้าประเภทนั้น พร้อมสถิติ
  - **Monthly Breakdown** — กราฟแท่งและตารางแสดงยอดใช้จ่ายรายเดือนของประเภทนั้น (คลิกเดือนเพื่อไปยังหน้า Items ที่กรองตาม type และเดือน)
...
ด้านล่างของหน้า Types มีส่วน **Members by Type** แสดง accordion:
- ขยายแต่ละประเภทเพื่อดูรายชื่อสมาชิกที่ซื้อสินค้าประเภทนั้น
- แสดงกลุ่ม/ยูนิต และค่ายของแต่ละสมาชิก
- แสดงสถิติ: จำนวนรายการ จำนวนชิ้น และยอดใช้จ่าย
...
2. กรอกข้อมูล:
   ...
   - **Password** - รหัสผ่าน (ขั้นต่ำ **12 ตัวอักษร**)
...
- รหัสผ่านใหม่ต้องมีความยาวขั้นต่ำ **12 ตัวอักษร**
...
## 9. นำเข้า/ส่งออกข้อมูล Excel

### ส่งออกข้อมูล (Export)

ส่งออกรายการสินค้าที่ตรงกับ filter ที่เลือกอยู่ (หรือทั้งหมดถ้าไม่ได้กรอง)

1. เลือก filter ที่ต้องการในหน้า Items (ถ้าต้องการ export เฉพาะบางส่วน)
2. กดปุ่ม **"Export Excel"** ใน Navbar
3. ระบบจะดาวน์โหลดไฟล์ `.xlsx` ทันที
...
> สามารถ Export ได้ทุก Role (Admin และ User)
